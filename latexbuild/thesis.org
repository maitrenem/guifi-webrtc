...
- Opportunities
  ...
  - It encourages a new generation of web applications using its strenghts. For example, WebRTC can easily implement through a web page a /click to call button/ or a phone box[fn:95] (call without account).
...
Figure [[fig:cw]] shows the next screen. bob is succesfully registered. To perform a call, fill green box with SIP URI and click call.
...
* Demo installation
Install in your own server the demo. This guide assumes a Debian 7 Wheezy installation with Internet access and administration rights.
