...
#+CAPTION: Bandwidth and delay parameters
#+NAME: fig:cvs
[[../img/conversation-video-stats.png]]

Figure [[fig:cdj]] gives jitter parameter of a fragment, and another delay measure of another fragment. Sometimes the network become unstable, in that case was not perceived loss of audio.

#+CAPTION: Jitter and delay parameters
#+NAME: fig:cdj
