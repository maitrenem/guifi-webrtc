...
*Presentation and control*. W3C APIs define the user interaction with the browser. W3C Working Draft /WebRTC 1.0: Real-time Communication Between Browsers[fn:39]/ define important API interfaces: (1) RTCPeerConnection in section /Peer-to-peer connections/, (2) RTCDatachannel in section /Peer-to-peer Data API/, (3) RTCStats in section /Statistics Model/, (4) RTCSessionDescription (JSEP) in section Session Description Model.\\
W3C Working Draft /Media Capture and Streams[fn:40]/ defines the Media Capture API. It manages the local media devices such as audio and video.

*Local system support functions*
User experience: echo cancellation, volume control, camera management including focus, zoom, pan/tilt controls (if available), and more. /A grandes rasgos/ From audio, video and MediaStream API

# G.711 PCMA and PCMU with the payload format specified in section 4.5.14 of [RFC3551].
# G.711 voip interop

# auto audio level, automatic gain control (AGC)
# acoustic echo cancellation

# camera source video: automatic focus, white balance, light level control, dynamic frame rate

# Mandatory to implement video codec https://tools.ietf.org/html/draft-ietf-rtcweb-video-05#section-5


\cite{wrtc2014loreto} was consulted as an additional source of information about WebRTC.
* TODO Methodology
